...
function sendMail($to,$title,$content){
    ...
    $mail->FromName = '发件人姓名';//设置发件人姓名（昵称） 任意内容，显示在收件人邮件的发件人邮箱地址前的发件人姓名
    $mail->Username ='*******@163.com';//smtp登录的账号 这里填入字符串格式的qq号即可
    $mail->Password = 'XJVV******BOFK';//smtp登录的密码 使用生成的授权码（就刚才叫你保存的最新的授权码）【非常重要：在网页上登陆邮箱后在设置中去获取此授权码】
    $mail->From = '*******@163.com';//设置发件人邮箱地址 这里填入上述提到的“发件人邮箱”
...
// 发送邮件
sendMail('152*****998@163.com',$_POST['title'],$_POST['content']);
